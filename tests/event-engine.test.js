...
const discovered=E.normalizeEvent({...seed,id:"discovery",sourceUrl:"https://www.defense.gov/News/Releases/1",seed:false,discovery:{temporaryWatchZone:true,score:85,scoreReasons:["strategic weapon","new location"],scoreExplanation:"CONFIRMED deployment + strategic weapon + new location"},evidence:{confirmed:{sourceUrl:"https://www.defense.gov/News/Releases/1",sourceName:"DoD",text:"Official release"},observed:[{hex:"abc",callsign:"RCH1",type:"C17"}],inferred:[{text:"related military airlift observed"}]}});assert.equal(discovered.discovery.score,85);assert.equal(discovered.evidenceDetail.observed[0].evidence,"OBSERVED");
