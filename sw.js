...
const CACHE="nordicwatch-v1.1-collector-swarm-1";
const APP_SHELL=["./","./index.html","./aircraft-classifier.js","./special-mission-analysis.js","./coast-guard-analysis.js","./background-monitor-core.js","./maritime-core.js","./maritime-patterns.js","./intelligence-core.js","./event-state.js","./event-state-ui.js","./data/verified-event-followups.json","./situation-engine.js","./news-freshness.js","./news-routing.js","./germany-infrastructure.js","./germany-ui.js","./brief-engine.js","./situation-ui.js","./collector-swarm.js","./scan-cards.js","./event-engine.js","./situational-engine.js","./route-pattern.js","./uav-incidents.js","./external-report-core.mjs","./mock/events.json","./mock/maritime-signals.json","./mock/uav-incidents.json","./mock/external-military-reports.json","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
