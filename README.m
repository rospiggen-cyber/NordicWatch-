# NordicWatch v1.1 — Detection, Correlation, Behaviour & Baseline Engine
...
v1.1 does not implement user authentication or a payment wall. Browser notification permission is not authentication. Settings, deduplication state and some fallback history are stored locally and must not be treated as access control.
