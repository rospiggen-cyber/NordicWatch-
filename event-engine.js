(function(root,factory){
  ...
  const OFFICIAL_HOSTS=["nato.int","forsvarsmakten.se","puolustusvoimat.fi","mil.ee","mil.lv","mod.gov.lv","kariuomene.lt","forsvaret.no","gov.pl","joint-expeditionary-force.com","gov.uk"];
